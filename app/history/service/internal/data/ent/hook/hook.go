...
type HistoryFunc func(context.Context, *ent2.HistoryMutation) (ent2.Value, error)

// Mutate calls f(ctx, m).
func (f HistoryFunc) Mutate(ctx context.Context, m ent2.Mutation) (ent2.Value, error) {
	mv, ok := m.(*ent2.HistoryMutation)
	if !ok {
